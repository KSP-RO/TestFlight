...
//        internal Settings settings = null;
        ...
        internal override void Start()
        {
            ...
            tfScenario = game.scenarios.Select(s => s.moduleRef).OfType<TestFlightManagerScenario>().FirstOrDefault();
//            settings = tfScenario.settings;
//            if (settings == null)
//            {
//                LogFormatted_DebugOnly("Setting is NULL");
...
//            settings.Load();
        ...
        internal override void OnGUIOnceOnly()
        {
            ...
            WindowRect = tfScenario.settings.mainWindowPosition;
