...
namespace TestFlight
{
	public class FlightDataBody : IConfigNode
	{
		...
		public override string ToString()
		{
			...
			stringRepresentation = String.Format ("{0},{1:F4},{2:F4}", bodyName, dataSpace, dataAtmosphere);
	...
	public class FlightDataRecorder : PartModuleWindow
	{
		...
		public float GetCurrentData()
		{
			...
			return GetData (currentBody, situation);
		}
